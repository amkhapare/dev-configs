...
" key remaps for moving lines  -Ctrl+j-  -Ctrl+k-
nnoremap <C-j> :m .+1<CR>==
...
" Search file -Ctrl+f--
"inoremap <S-f> <ESC>:Files<CR>
nnoremap <S-f> <ESC>:Files<CR>
vnoremap <S-f> <ESC>:Files<CR>
...
" coc config
"let g:coc_node_path = '/Users/aamanjun/.nvm/versions/node/v14.5.0/bin/node'
